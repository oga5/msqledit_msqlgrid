...
public:
	...
	CMyGridData *GetOrigGridData() { return &m_grid_data; }
	...
	HMyDataset	GetDataset() { return m_dataset; }
	void SetDataset(HMyDataset dataset, HWND hWnd);
